...
#        return await query.answer("𝐂𝐥𝐨𝐬𝐞𝐝", show_alert=True) 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Exᴛʀᴀ Mᴏᴅs', callback_data='modules1')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴘᴇᴄɪᴀʟ ᴍᴏᴅ', callback_data='special_mod'),
